...
namespace OrionDev.Infrastructure.Data.Database.Migrations
{
    ...
    [Migration("20250529220038_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Expedition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Join.UserMission", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Mission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.MissionModule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Moon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Planet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.SolarSystem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MissionMission", b =>
                {
                    b.HasOne("OrionDev.Domain.Entities.Mission", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Comment", b =>
                {
                    b.HasOne("OrionDev.Domain.Entities.Expedition", "Expedition")
                        .WithMany("Comments")
                        .HasForeignKey("ExpeditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OrionDev.Domain.Entities.User", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Expedition", b =>
                {
                    b.HasOne("OrionDev.Domain.Entities.MissionModule", "MissionModule")
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Join.UserMission", b =>
                {
                    b.HasOne("OrionDev.Domain.Entities.Mission", "Mission")
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Mission", b =>
                {
                    b.HasOne("OrionDev.Domain.Entities.Moon", "Moon")
                        .WithOne("Mission")
                        .HasForeignKey("OrionDev.Domain.Entities.Mission", "MoonId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("OrionDev.Domain.Entities.Planet", "Planet")
                        .WithMany()
                        .HasForeignKey("PlanetId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.OwnsOne("OrionDev.Domain.VOs.MissionDetail", "Detail", b1 =>
                        {
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Moon", b =>
                {
                    ...
                    b.OwnsOne("OrionDev.Domain.VOs.Appearance", "Appearance", b1 =>
                        {
                            ...
                            b1.OwnsOne("ColorPalette", "ColorPalette", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("OrionDev.Domain.VOs.Gradient", "Gradient", b3 =>
                                        {
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.Planet", b =>
                {
                    b.HasOne("OrionDev.Domain.Entities.SolarSystem", "SolarSystem")
                        .WithMany("Planets")
            ...
            modelBuilder.Entity("OrionDev.Domain.Entities.User", b =>
                {
                    b.OwnsOne("OrionDev.Domain.VOs.Email", "Email", b1 =>
                        {
                    ...
                    b.OwnsOne("OrionDev.Domain.VOs.Password", "Password", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");
